label start:
    ...
    if persistent.playthrough == 0:
        ...
        python:
            try: renpy.file(config.basedir + "/ㅎㅐxㅂㅗㄱㅎㅏㄴ ㅅㅐxㄱㅏㄱ.png")
            except: open(config.basedir + "/ㅎㅐxㅂㅗㄱㅎㅏㄴ ㅅㅐxㄱㅏㄱ.png", "wb").write(renpy.file("hxppy thxughts.png").read())
        $ chapter = 5
        ...
        label playthrough2:
            ...
            python:
                try: renpy.file(config.basedir + "/내 말 들리니.txt")
                except: open(config.basedir + "/내 말 들리니.txt", "wb").write(renpy.file("CAN YOU HEAR ME.txt").read())
            ...
            python:
                try: renpy.file(config.basedir + "/나나나나나나나나나나나나나나나나나나나나나나나나나나나나.txt")
                except: open(config.basedir + "/나나나나나나나나나나나나나나나나나나나나나나나나나나나나.txt", "wb").write(renpy.file("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii.txt").read())
